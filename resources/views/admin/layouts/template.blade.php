...
<head>
    ...
    <link rel="stylesheet" href="{{asset('dashboard/asset/vendor/fonts/boxicons.css')}}">
    {{asset('dashboard/asset')}}
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('dashboard/asset/vendor/css/core.css')}}"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{asset('dashboard/asset/vendor/css/theme-default.css')}}"
                ...
                <ul class="menu-inner py-1">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('allCategory')}}" class="menu-link">
                                    <div data-i18n="Without menu">Tất cả danh mục</div>
                                </a>
                            </li>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('allProducts')}}" class="menu-link">
                                    <div data-i18n="Basic">Tất cả sản phẩm</div>
                                </a>
                            </li>
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Misc">Sub cate</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('allSubCategory')}}" class="menu-link">
                                    <div data-i18n="Error">Tất cả sub</div>
                                </a>
                            </li>
