...
<div class="modal fade" id="editSub-{{$id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 60em;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Sửa hạng mục {{$allSub->id}}</h5>
            ...
            <div class="modal-body">
                <form method="POST" action="{{route('updateSubCategory')}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="Sub_Category_Name" id="Sub_Category_Name"
                                   placeholder="tên danh mục" value="{{$allSub->Sub_Category_Name}}" />
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary">Sửa mới sub</button>
                        </div>
                    </div>
